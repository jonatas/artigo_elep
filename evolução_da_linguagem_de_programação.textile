1. Evolução da linguagem de programação
...
1.1.1 Exemplo de um programa que imprime a mensagem 'Hello, world!' usando a linguagem de programação assembly:
<pre>
   variable:
...
1.1.2: Exemplo de um programa que imprimi a mensagem 'Hello, world!' usando a linguagem de programação ruby:
<source:ruby>
   print "Hello, world!"
</source>
